...
class SparseFeatureFusion3DGrounder(BaseModel):
    ...
    def extract_feat(
        ...
        # print('points dtype and shape:', points[0].dtype, len(points))
        ...
        # print('coordinates dtype:', coordinates.dtype)
    ...
    def pre_decoder(
        ...
        enc_outputs_class = self.bbox_head.cls_branches[
            self.decoder.num_layers](feats, pred_embeddings,
                                     feats_mask)
    ...
    def loss(self, batch_inputs_dict: dict, batch_data_samples: SampleList,
        ...
        # text_dict['text_token_mask'] = text_token_mask  # (bs, max_batch_length)
    ...
    def predict(self, batch_inputs_dict, batch_data_samples, pred_embeddings):
        ...
        # pred_embeddings (num_batch_loc_tokens, C)
        # text_prompts = [
        #     data_samples.text for data_samples in batch_data_samples
        # ]  # txt list
