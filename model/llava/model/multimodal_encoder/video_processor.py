...
class RGBDVideoProcessor(ProcessorMixin):
    ...
    """
    def __init__(self, vision_tower_name, video_info_file, num_frames=24, tokenizer=None, **kwargs):
        super().__init__(**kwargs)
        self.vision_tower_name = vision_tower_name
        self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_tower_name)
        self.tokenizer = tokenizer
        self.num_frames = num_frames
        self.scene = mmengine.load(video_info_file)
    ...
    def extract_embodiedscan_video(self, video):
        ...
        for frame in sample_frames:
            ...
            if 'scannet' in frame:
                ...
                # depth = os.path.join(video_folder, frame.replace('color.jpg', 'depth.png'))
    ...
    def preprocess_depth_image(self, depth_image, do_depth_scale=True, depth_scale=1000):
        ...
        # resize 这里注意到需要使用 NEAREST 的方法进行插值  (448, 336)
