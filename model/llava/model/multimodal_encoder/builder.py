...
def build_video_tower(video_tower_cfg, **kwargs):
    ...
    video_info_file = getattr(video_tower_cfg, 'video_info_file', getattr(video_tower_cfg, 'video_info_file', None))
    if video_tower.endswith('CrossViewAttention') or video_tower.endswith('SpatialAwareModule'):
        return RGBDVideoTower(vision_tower, video_tower, video_info_file, args=video_tower_cfg, **kwargs)
